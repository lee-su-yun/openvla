...
if __name__ == "__main__":
   ...
   #  with open("/sdb1/piper_subtask_data/train/pick/train_np/Pick the blue cup in the center./episode1.pickle", "rb") as f:
    ...
    model_path = "/ckpt/piper_subtask/openvla/Fully/openvla-7b+piper5_hz_subtask+b16+lr-0.0005+val+qlora-r32+dropout-0.0--image_aug+norm/step_10000"
   ...
   # Pick
    ...
    for i in range(30, 270, 6):
        ...
        x.append(data['observation.state'][i+6][0][0]-data['observation.state'][i][0][0])
        y.append(data['observation.state'][i+6][0][1]-data['observation.state'][i][0][1])
        z.append(data['observation.state'][i+6][0][2]-data['observation.state'][i][0][2])
        rx.append(data['observation.state'][i+6][0][3]-data['observation.state'][i][0][3])
        ry.append(data['observation.state'][i+6][0][4]-data['observation.state'][i][0][4])
        rz.append(data['observation.state'][i+6][0][5]-data['observation.state'][i][0][5])
        #g.append(data['observation.state'][i+6][0][6]-data['observation.state'][i][0][6])
    gt_111.append(x)
    gt_111.append(y)
    gt_111.append(z)
    gt_111.append(rx)
